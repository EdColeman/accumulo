...
public class SystemConfiguration extends ZooBasedConfiguration {
  ...
  // for Upgrader9to10 code only
  @Deprecated
  public SystemConfiguration(ServerContext context, AccumuloConfiguration parent) {
    super(log, context, CacheId.forSystem(context), parent);
  }
