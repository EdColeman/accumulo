...
public class PropCacheId implements Comparable<PropCacheId> {
  ...
  public static String sysZooRootPath(final String instanceId) {
    return ZooUtil.getRoot(instanceId) + ZCONFIG;
  }

  public static String namespaceZooRootPath(final String instanceId,
      final NamespaceId namespaceId) {
    return ZooUtil.getRoot(instanceId) + ZCONFIG;
  }

  public static String tableZooRootPath(final String instanceId, final TableId tableId) {
    return ZooUtil.getRoot(instanceId) + ZCONFIG;
  }
