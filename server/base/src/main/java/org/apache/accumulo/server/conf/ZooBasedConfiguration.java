...
public abstract class ZooBasedConfiguration extends AccumuloConfiguration implements PropWatcher {
  ...
  public void deleteEvent(final CacheId id) {
    if (this.cacheId.equals(id)) {
      throw new UnsupportedOperationException("DELETE " + id);
    }
  }
  ...
  protected Map<String,String> getSnapshot() {
    ...
    try {
      ...
      throw new IllegalStateException("failed to read properties for cacheId " + cacheId, ex);
    }
  }
