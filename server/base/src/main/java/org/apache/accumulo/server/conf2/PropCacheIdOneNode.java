...
public class PropCacheIdOneNode implements Comparable<PropCacheIdOneNode> {
  ...
  private static final Pattern pathPattern = Pattern.compile(
      ZROOT + "/(?<uuid>[a-f0-9-]{36})" + ZENCODED_CONFIG_ROOT + "/(?<ns>\\S+)::(?<tid>\\S+)");
  ...
  public static String getConfigRoot(final String instanceId) {
    return ZROOT + "/" + instanceId + ZENCODED_CONFIG_ROOT;
  }
   ...
   */
  public String path() {
    return ZROOT + "/" + iid + ZENCODED_CONFIG_ROOT + "/" + nodeName();
  }
  ...
  public String toString() {
    ...
    sb.append("PropCacheId1{ instance: ");
    sb.append(iid);
