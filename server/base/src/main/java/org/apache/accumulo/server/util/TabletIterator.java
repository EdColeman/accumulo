  ...
  public boolean hasNext() {
    while (currentTabletKeys == null) {
      ...
      if (currentTabletKeys.size() == 0) {
        // Always expect the default tablet to exist for a table. The following checks
        // for the case when the default tablet was not seen when it should have been seen.
        if (lastTablet != null) {
