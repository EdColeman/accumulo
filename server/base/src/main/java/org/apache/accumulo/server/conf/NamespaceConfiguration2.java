...
public class NamespaceConfiguration2 extends ZooBasedConfiguration {

  private static final Logger log = LoggerFactory.getLogger(NamespaceConfiguration2.class);
  ...
  protected NamespaceId getNamespaceId() {
    return getCacheId().getNamespaceId().orElseThrow(
        () -> new IllegalArgumentException("Invalid request fro namespace id on " + getCacheId()));
  }
