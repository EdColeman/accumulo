...
public class TableConfiguration2Test {
  ...
  private NamespaceConfiguration2 parent;

  private TableConfiguration2 c;
  ...
  public void setUp() {
    ...
    parent = createMock(NamespaceConfiguration2.class);
    c = new TableConfiguration2(context, TID, parent);
