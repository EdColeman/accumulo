...
public class ReadyMonitorTest {
  ...
  public void init() {
    ...
    pool = ThreadPools.createFixedThreadPool(numPoolThreads, "readyMonitor-test-pool", false);
  }
  ...
  private static class ReadyTask implements Callable<Long> {
    ...
    public Long call() throws Exception {
      ...
      readyMonitor.isReady(readyTimeout);
