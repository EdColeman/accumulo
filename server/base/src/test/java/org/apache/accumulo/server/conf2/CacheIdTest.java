...
public class CacheIdTest {
  ...
  public void compareTest() {
    ...
    var path = id1.path();
    CacheId id2 = CacheId.fromPath(path).orElse(null);
  ...
  public void invalidPath1Test() {
    ...
    // go path
    var goPath = "/accumulo/c227b233-39b9-47b6-a7da-7a1035941ac0/config2/1::1";
    Optional<CacheId> id1 = CacheId.fromPath(goPath);
    assertTrue("path failed to pass validation", id1.isPresent());

    var badPath = "/error/c227b233-39b9-47b6-a7da-7a1035941ac0/config2/1::1";
  ...
  public void invalidPath2Test() {
    var badPath = "/accumulo/1-39b9-47b6-a7da-7a1035941ac0/config2/1::1";
  ...
  public void invalidPath3Test() {
    ...
    var path = "/accumulo/Z227b233-39b9-47b6-a7da-7a1035941ac0/config2/1::1";
  ...
  public void invalidPath4Test() {
    ...
    Optional<CacheId> id = CacheId.fromPath(path);
    log.trace("should reject invalid path: {} - received {}", path, id);
    assertFalse("path should have failed to pass validation - invalid config2 path",
        id.isPresent());
  }
  ...
  public void invalidPath5Test() {
    ...
    var path = "/accumulo/c227b233-39b9-47b6-a7da-7a1035941ac0/config2/::1";
    Optional<CacheId> id = CacheId.fromPath(path);
    log.trace("should reject invalid path: {} - received {}", path, id);
  ...
  public void invalidPath7Test() {
    ...
    var path = "/accumulo/c227b233-39b9-47b6-a7da-7a1035941ac0/config2/1-1";
    Optional<CacheId> id = CacheId.fromPath(path);
    log.trace("should reject invalid path: {} - received {}", path, id);
    assertFalse("path should have failed to pass validation - invalid node name", id.isPresent());
  }
